...
select u.Id, u.username, (NOW()-u.authenticationTime) as authenticateTimeDifference, u.IP, f.providerId, f.requestId, f.status, u.port from friends f left join users u on u.Id = if ( f.providerId = '7', f.requestId, f.providerId ) where (f.providerId = '7' and f.status= '1')  or f.requestId = 7;
...
///////////////////////////////////////////////////////////////
// returns the Id for that $username
